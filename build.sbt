...
lazy val core = project.settings(commonSettings).settings(
  Seq(
    ...
    libraryDependencies ++= Seq(
      ...
      "com.twitter" %% "finagle-redis" % versions.twitterLibraries,
      "com.twitter" %% "bijection-util" % versions.bijection_util,
      "net.codingwell" %% "scala-guice" % versions.scalaGuice,
      "mysql" % "mysql-connector-java" % versions.mySqlDriverVersion,
      ...
      "io.paradoxical" %% "rdb-test" % versions.paradox.slick % "test",
